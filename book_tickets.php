    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Search for Available Flights</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <form method="post" action="view_flights_form_handler.php">
                    <!-- SELECT2 EXAMPLE -->
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6 col-md-6">
                                    ...
                                    <select class="select2bs4" type="text" name="origin"
                                        ...
                                        <!--                                    --><?php
                                        //                                    $countries = ['', 'Colombo - Sri Lanka', 'Jaffna - Sri Lanka', 'Batticaloa - Sri Lanka', 'Hambantota - Srilanka'];
                                        //                                    foreach ($countries as $country) {
                                        //                                        echo "<option>$country</option>";
                                        //                                    }
                                        //                                    ?>
                                ...
                                <div class="form-group col-sm-4 col-md-4">
                                    ...
                                    <div class="input-group">
                                        <input type="number" min="1" max="10" name="no_of_pass" class="form-control"
                                               required>
                                ...
                                <div class="form-group col-sm-4 col-md-4">
                                    ...
                                    <select class="select2bs4" type="text" name="class"
                                            data-placeholder="Select Class Type" style="width: 100%" required>
