    ...
    <div class="admin-dashboard">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="add_flight_details.php" class="nav-link active">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                ...
                <div class="row mb-2">
                    <div class="col-sm-8">
                        <h1 class="m-0 text-dark card-title">Add New Flight/Ticket Schedule</h1>

                    </div><!-- /.col -->
                    <div class="col-sm-4">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="admin_homepage.php">Admin</a></li>
                            <li class="breadcrumb-item active">New Ticket Schedule</li>
                        </ol>
                    </div><!-- /.col -->
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <form method="post" action="add_flight_details_form_handler.php">
                        <!-- SELECT2 EXAMPLE -->
...
<div class=\"alert alert-success alert-dismissible fade show\">
    <strong>Success!</strong> The Ticket Schedule has been successfully added.
...
";
    ...
    <strong>Error!</strong> Invalid Ticket Schedule Details, please try again.
    <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>
</div>";
                                    }
                                        ...
                                        <select class="select2" type="text" name="jet_id"
                                            ...
                                            if ($result = mysqli_query($dbc, $sql)) {
                                                if (mysqli_num_rows($result) > 0) {
                                                    ...
                                                    echo "<option disabled>Aircraft/Jet Details Not Added</option>";
                                                }
                                            }
                                            mysqli_close($dbc);
                                            ?>
                                    ...
                                    <div class="form-group col-sm-6 col-md-6">
                                        <label>Flight Schedule No:</label>
                                        <div class="input-group">
                                            <input type="text" placeholder="Enter Flight No. (Eg. GFA000)"
                                                   name="flight_no"
                                    ...
                                    <div class="form-group col-sm-6 col-md-6">
                                        ...
                                        <select class="select2bs4" type="text" name="origin"
                                                data-placeholder="Search Origin" style="width: 100%" required>
                                    ...
                                    <div class="form-group col-sm-6 col-md-6">
                                        ...
                                        <select class="select2bs4" type="text" name="destination"
                                    ...
                                    <div class="form-group col-sm-6 col-md-6">
                                        ...
                                        <div class="input-group date" id="departuredate" data-target-input="nearest">
                                            <input type="text" name="dep_date" class="form-control datetimepicker-input"
                                                   data-target="#departuredate" required/>
                                    ...
                                    <div class="form-group col-sm-6 col-md-6">
                                        ...
                                        <div class="input-group date" id="departuretimepicker"
                                            ...
                                            <input type="text" name="dep_time" class="form-control datetimepicker-input"
                                                   data-target="#departuretimepicker" required/>
                                            <div class="input-group-append" data-target="#departuretimepicker"
                                                 data-toggle="datetimepicker">
                                    ...
                                    <div class="form-group col-sm-6 col-md-6">
                                        ...
                                        <div class="input-group date" id="arrivaldate" data-target-input="nearest">
                                            <input type="text" name="arr_date" class="form-control datetimepicker-input"
                                                   data-target="#arrivaldate" required/>
                                            <div class="input-group-append" data-target="#arrivaldate"
                                                 data-toggle="datetimepicker">
                                                <div class="input-group-text">
                                                    <i class="fa fa-calendar-alt"></i>
                                                </div>
                                    ...
                                    <div class="form-group col-sm-6 col-md-6">
                                        ...
                                        <div class="input-group date" id="arrivaltimepicker"
                                             data-target-input="nearest">
                                            <input type="text" name="arr_time" class="form-control datetimepicker-input"
                                    ...
                                    <div class="form-group col-sm-6 col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="price_eco" class="form-control" required>
                                    ...
                                    <div class="form-group col-sm-6 col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="price_bus" class="form-control" required>
                                            <div class="input-group-append">
                                                <span class="input-group-text">.00</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group col-sm-6 col-md-6">
                                        <label>No of Seats in Economy Class:</label>
                                        <select class="select2bs4" type="number" name="seats_eco"
                                                data-placeholder="Select Economy Class Seats"
                                                style="width: 100%" required>
                                            <?php
                                            $eco_seats = ['', 175, 150, 125, 100, 75, 50];
                                            foreach ($eco_seats as $seat) {
                                    ...
                                    <div class="form-group col-sm-6 col-md-6">
                                        <label>No of Seats in Business Class:</label>
                                        <select class="select2bs4" type="number" name="seats_bus"
                                                data-placeholder="Select Business Class Seats"
                                                style="width: 100%" required>
                                            <?php
                                            $bus_seats = ['', 25, 50, 75, 100, 125];
                            ...
                            <span><b>Note:</b> (No of Seats in Economy Class) <b>+</b> (No of Seats in Business
                                Class) <b>=</b> Aircraft/Jet Capacity</span>
                                </div>
                            </div>
                        </div>
                        <!-- /.card -->
