                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="deactivate_jet_details.php" class="nav-link active">
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Enter To Deactivate Aircraft/Jet.</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="admin_homepage.php">Admin</a></li>
                            <li class="breadcrumb-item active">Deactivate Aircraft</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            ...
            <div class=\"alert alert-danger alert-dismissible\">
                  ...
                  <h5><i class=\"icon fas fa-ban\"></i> Alert.!</h5>Invalid Aircraft/Jet ID. Please Try Again...!
            ...
            <div class=\"alert alert-success alert-dismissible\">
                  ...
                  The Aircraft/Jet Details has been successfully Deactivated.  
                </div>
            ";
            }
                            ...
                            <form action="deactivate_jet_details_form_handler.php" method="post">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select class="select2" type="text" name="jet_id"
                                        ...
                                        $sql = "SELECT * FROM Jet_Details WHERE active='Yes'";
                                        ...
                                        if ($result = mysqli_query($dbc, $sql)) {
                                            if (mysqli_num_rows($result) > 0) {
                                                ...
                                                echo "<option disabled>All Aircraft/Jets are Already Deactivated.</option>";
                                            }
                                        }
                                        mysqli_close($dbc);
                                        ?>
