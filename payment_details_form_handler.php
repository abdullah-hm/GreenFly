...
<?php
			if(isset($_POST['Pay_Now']))
			{
				...
				$final_grand_total_amount = $_SESSION['final_grand_total_amount'];
				...
				*/
				if($affected_rows_1==1)
				{
					...
					$stmt=mysqli_prepare($dbc,$query);
					mysqli_stmt_bind_param($stmt,"sssis",$payment_id,$pnr,$payment_date,$final_grand_total_amount,$payment_mode);
					mysqli_stmt_execute($stmt);
					...
					if($affected_rows_2==1)
					{
						...
						header("location:payment_details.php?msg=success");
					}
					else
					{
						echo "Submit Error";
						echo mysqli_error();
                        header("location:payment_details.php?msg=failed");
					}
				}
				else
				{
